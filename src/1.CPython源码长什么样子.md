...
工欲善其事，必先利其器，在剖析源码之前，要先将它下载下来，并熟悉里面的结构。我们登录 Python 官网下载 CPython，我们本系列剖析的版本是 3.8.8，你可以点击此[链接](https://www.python.org/ftp/python/3.8.8/Python-3.8.8.tgz)进行下载。
...
本文就说到这里，赶快下载 Python 3.8 源码，来和我一起学习 Python 吧。
