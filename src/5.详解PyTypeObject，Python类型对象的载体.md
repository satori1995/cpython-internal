...
-  \<class 'int'\>  ->  PyLong_Type
-  \<class 'str'\>  ->  PyUnicode_Type
-  \<class 'float'\>  ->  PyFloat_Type
-  \<class 'complex'\>  ->  PyComplex_Type
-  \<class 'tuple'\>  ->  PyTuple_Type
-  \<class 'list'\>  ->  PyList_Type
-  \<class 'dict'\>  ->  PyDict_Type
-  \<class 'set'\>  ->  PySet_Type
-  \<class 'frozenset'\>  ->  PyFrozenSet_Type
-  \<class 'type'\>  ->  PyType_Type
